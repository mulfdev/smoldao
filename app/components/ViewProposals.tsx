                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="space-y-0.5">
                                        <p className="text-gray-100 text-sm">
                                            {proposal.voteStart
                                                ? getBlockTimeFromNow(proposal.voteStart)
                                                : "Unknown"}
                                        </p>
                                        <p className="text-xs text-gray-500">
                                            Block{" "}
                                            {getNetworkBlock(proposal.voteStart).toLocaleString()}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="space-y-0.5">
                                        <p className="text-gray-100">
                                            {proposal.voteEnd
                                                ? getBlockTimeFromNow(proposal.voteEnd)
                                                : "Unknown"}
                                        </p>
                                        <p className="text-xs text-gray-500">
                                            Block #
                                            {getNetworkBlock(proposal.voteEnd).toLocaleString()}
                                        </p>
                                    </div>
                                </div>
                            </div>
